...
use crate::plugins::{diagnostics::Playtest, input::CapturedInput};
...
pub(crate) struct Runtime {
    ...
    pub(crate) prediction: Option<DreamSimulation>,
    pub(crate) last_received: f64,
    last_send: f64,
    pub(crate) last_snapshot: Option<DreamSnapshot>,
...
impl Plugin for DreamNetworkPlugin {
    fn build(&self, app: &mut App) {
        app.add_systems(Startup, auto_connect)
            .add_systems(
                PreUpdate,
                poll_network.in_set(crate::plugins::input::DreamInputSystems::Receive),
            )
...
pub(crate) fn has_local_hero(snapshot: &DreamSnapshot, id: u64) -> bool {
