...
mod nested_reference {
    ...
    pub fn simulation(seed: u64, lucid: bool) -> DreamSimulation {
        ...
        app.add_plugins((
            engine_core::PresentationPlugin(Old::Presentation),
            engine_core::HealthPlugin(Old::Health),
            engine_core::CombatPlugin(Old::Actors),
            ...
            engine_core::SummonPlugin::new(Old::Summon),
    ...
    fn advance(world: &mut World) {
        ...
        let phase = run.phase;
        world.run_schedule(Old::Presentation);
